...
public class EventMailSender {
     ...
     */
    private Queue<HeliosEvent<?>> eventQueue = new ConcurrentLinkedQueue<>();
     ...
     * @return subject
     */
    private String buildSubject(Queue<HeliosEvent<?>> sendQueue) {
     ...
     * @return text
     */
    private String buildText(Queue<HeliosEvent<?>> sendQueue) {
        Function<HeliosEvent<?>, String> eventToText = e -> {
            ...
            var clazz = event.getSource();
            var message = event.getSubject().getMessage();
